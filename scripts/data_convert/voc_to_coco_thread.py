...
def convert(fig_names_all, xmldirs_all, fig_save):
    ...
    for i in range(len(fig_names_all)):
        ...
        for obj in get(root, 'object'):
            ...
            assert category in categories, f"error category image:{figname}"
...
if __name__ == '__main__':
    ...
    READ_PATH = "sample/yolo"
    json_file = "sample/yolo/pascal_train.json"
    fig_save="sample/yolo/cocoImage"
    level=1
